...
function (_React$PureComponent) {
  _inherits(ContentWell, _React$PureComponent);

  function ContentWell() {
    _classCallCheck(this, ContentWell);

    return _possibleConstructorReturn(this, _getPrototypeOf(ContentWell).apply(this, arguments));
  }

  _createClass(ContentWell, [{
    key: "render",
