 ...
 */
var FandomBackgroundImage =
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(FandomBackgroundImage, _React$PureComponent);

  function FandomBackgroundImage() {
    _classCallCheck(this, FandomBackgroundImage);

    return _possibleConstructorReturn(this, _getPrototypeOf(FandomBackgroundImage).apply(this, arguments));
  }

  _createClass(FandomBackgroundImage, [{
    key: "render",
